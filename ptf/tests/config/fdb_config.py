...
class FdbT0Config(object):
    ...
    def config_fdb(self, test):
        ...
        # self.create_fdb_entries(test, test.vlan10_mac_list, 1, SAI_FDB_ENTRY_TYPE_STATIC, vlan_oid=test.vlan10)

        # test.vlan20_mac_list = generate_mac_address_list(FDB_MAC_PREFIX, 99, 2, 9, 16)
        # self.create_fdb_entries(test, test.vlan20_mac_list, 9, SAI_FDB_ENTRY_TYPE_STATIC, vlan_oid=test.vlan20)
